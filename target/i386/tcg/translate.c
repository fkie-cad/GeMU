...
static bool disas_insn(DisasContext *s, CPUState *cpu)
{
 ...
 next_byte:
    ...
    case 0x134: /* sysenter */
        ...
        printf("sysenter in the translate\n");
    ...
    case 0x105: /* syscall */
        ...
        //printf("I am translatiing a syscall :)\n");
        gen_update_cc_op(s);
        gen_update_eip_cur(s);
        if(gemu_compile_syscall_helper){
            gen_helper_gemu_syscall_tracking(cpu_env, cur_insn_len_i32(s));
        }
    ...
    case 0x107: /* sysret */
        if (!PE(s)) {
            ...
            if (gemu_compile_syscall_helper){
                gen_helper_gemu_sysret_tracking(cpu_env, tcg_constant_i32(dflag - 1));
            }
